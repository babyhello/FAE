...
class ProductInfoTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "ProductCell", for: indexPath) as! ProductInfoTableViewCell
...
//        let gapView : UIView = UIView(frame: CGRect(x: 0, y: 10, width: self.view.frame.size.width, height: 120))
//
//     
//        gapView.layer.backgroundColor = UIColor(hexString: "#111111").cgColor
//        gapView.layer.masksToBounds = false
//        gapView.layer.cornerRadius = 2.0
//        gapView.layer.shadowOffset = CGSize(width: -1, height: 1)
//        gapView.layer.shadowOpacity = 0.2
//
//        cell.contentView.addSubview(gapView)
//        cell.contentView.sendSubview(toBack: gapView)
//
